...
def load_raw_data() -> pd.DataFrame:
    ...
    data = format_data(data, set_missing_as_NA=True) # combines all seperate dataframes (1 for each meter) into a single dataframe
    data.to_csv("time_series_matrix_no_missing.csv") # save results becaues its a lot of data and takes long
    return data
